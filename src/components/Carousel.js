  ...
  return (
    ...
    >
      <SwiperSlide>
        ...
        herself to understanding each client's distinct needs, researching new
        and existing resources to identify and hone in on the brand's voices.
        Never shying away from asking questions she made each story her own,
        leveraging every moment to build up client's brands.”
      </SwiperSlide>
      <SwiperSlide>
      ...
      <SwiperSlide>
        ...
        we needed and wrote on many different topic. Katherine never missed one deadline. It
