...
const PersonalWriting = () => {
  ...
  return (
    <div id="personal" style={{ paddingTop: "80px", paddingBottom: "100px" }}>
      <Container>
        <Row>
          <Col md={{ span: 4, offset: 5 }} style={{ paddingBottom: "40px" }}>
            <h1>Personal Writing</h1>
          </Col>
        </Row>
        <Row>
          <Col md={{ span: 5, offset: 4 }} style={{ textAlign: "center" }}>
            <p>
              From blog posts to featured pieces, links to my personal writing
              can be found here.
            </p>
          </Col>
        </Row>
